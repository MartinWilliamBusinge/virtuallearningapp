...
class ProbabilityAndStatisticsPage extends StatefulWidget {
  const ProbabilityAndStatisticsPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ProbabilityAndStatisticsPageState createState() =>
      _ProbabilityAndStatisticsPageState();
}

class _ProbabilityAndStatisticsPageState
    extends State<ProbabilityAndStatisticsPage> {
    ...
    if (result != null) {
      ...
      try {
        Reference ref = FirebaseStorage.instance
            .ref()
            .child('ProbabilityAndStatistics/$folderName/$fileName');
        ...
        await FirebaseFirestore.instance
            .collection('ProbabilityAndStatistics')
            .doc(folderName)
            .collection('files')
            .add({
          'fileName': fileName,
