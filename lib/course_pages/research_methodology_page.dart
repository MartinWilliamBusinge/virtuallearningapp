...
class ResearchMethodologyPage extends StatefulWidget {
  const ResearchMethodologyPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ResearchMethodologyPageState createState() =>
      _ResearchMethodologyPageState();
}

class _ResearchMethodologyPageState
    extends State<ResearchMethodologyPage> {
    ...
    if (result != null) {
      ...
      try {
        Reference ref = FirebaseStorage.instance
            .ref()
            .child('ResearchMethodology/$folderName/$fileName');
        ...
        await FirebaseFirestore.instance
            .collection('ResearchMethodology')
            .doc(folderName)
            .collection('files')
            .add({
          'fileName': fileName,
