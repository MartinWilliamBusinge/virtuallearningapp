...
class DiscreteMathPage extends StatefulWidget {
  const DiscreteMathPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DiscreteMathPageState createState() =>
      _DiscreteMathPageState();
}

class _DiscreteMathPageState
    extends State<DiscreteMathPage> {
    ...
    if (result != null) {
      ...
      try {
        Reference ref = FirebaseStorage.instance
            .ref()
            .child('DiscreteMath/$folderName/$fileName');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Discrete Maths'),
      ),
