...
class _CommunicationSkillsPageState
    extends State<CommunicationSkillsPage> {
    ...
    if (result != null) {
      ...
      try {
        Reference ref = FirebaseStorage.instance
            .ref()
            .child('CommunicationSkills/$folderName/$fileName');
        ...
        await FirebaseFirestore.instance
            .collection('CommunicationSkills')
            .doc(folderName)
            .collection('files')
            .add({
          'fileName': fileName,
