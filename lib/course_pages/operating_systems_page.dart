...
class OperatingSystemsPage extends StatefulWidget {
  const OperatingSystemsPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _OperatingSystemsPageState createState() =>
      _OperatingSystemsPageState();
}

class _OperatingSystemsPageState
    extends State<OperatingSystemsPage> {
    ...
    if (result != null) {
      ...
      try {
        Reference ref = FirebaseStorage.instance
            .ref()
            .child('OperatingSystems/$folderName/$fileName');
