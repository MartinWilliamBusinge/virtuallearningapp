...
class ComputerArchitecturePage extends StatefulWidget {
  const ComputerArchitecturePage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ComputerArchitecturePageState createState() =>
      _ComputerArchitecturePageState();
}

class _ComputerArchitecturePageState
    extends State<ComputerArchitecturePage> {
    ...
    if (result != null) {
      ...
      try {
        Reference ref = FirebaseStorage.instance
            .ref()
            .child('ComputerArchitecture/$folderName/$fileName');
        ...
        await FirebaseFirestore.instance
            .collection('ComputerArchitecture')
            .doc(folderName)
            .collection('files')
            .add({
          'fileName': fileName,
