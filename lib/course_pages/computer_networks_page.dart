...
class ComputerNetworksPage extends StatefulWidget {
  ...
  _ComputerNetworksPageState createState() =>
      _ComputerNetworksPageState();
}

class _ComputerNetworksPageState
    extends State<ComputerNetworksPage> {
    ...
    if (result != null) {
      ...
      try {
        Reference ref = FirebaseStorage.instance
            .ref()
            .child('ComputerNetworks/$folderName/$fileName');
