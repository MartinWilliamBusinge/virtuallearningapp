...
class AutomataPage extends StatefulWidget {
  const AutomataPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _AutomataPageState createState() =>
      _AutomataPageState();
}

class _AutomataPageState
    extends State<AutomataPage> {
    ...
    if (result != null) {
      ...
      try {
        Reference ref = FirebaseStorage.instance
            .ref()
            .child('Automata/$folderName/$fileName');
