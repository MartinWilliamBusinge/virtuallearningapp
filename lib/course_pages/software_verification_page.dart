...
class SoftwareVerificationPage extends StatefulWidget {
  const SoftwareVerificationPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _SoftwareVerificationPageState createState() =>
      _SoftwareVerificationPageState();
}

class _SoftwareVerificationPageState extends State<SoftwareVerificationPage> {
    ...
    if (result != null) {
      ...
      try {
        Reference ref = FirebaseStorage.instance
            .ref()
            .child('SoftwareVerification/$folderName/$fileName');
        ...
        await FirebaseFirestore.instance
            .collection('SoftwareVerification')
            .doc(folderName)
            .collection('files')
            .add({
          'fileName': fileName,
